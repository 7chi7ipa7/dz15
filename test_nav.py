...
class NavigationTest(BaseCase):
    ...
    def test_05_change_region(self):
        ...
        eng_text = self.get_text('//*[@id="products"]/article[1]')
        eng_money = self.get_text('//*[@id="products"]/article[1]/a/div[2]/p[3]/span[2]')
        ...
        ru_text = self.get_text('//*[@id="products"]/article[1]')
        ru_money = self.get_text('//*[@id="products"]/article[1]/a/div[2]/p[3]/span[2]')
        # английский текст не должен совпадать с русским
        self.assert_not_equal(eng_text, ru_text)
        self.assert_not_equal(eng_money, ru_money)
